 ...
 *   array A form array.
 */
function masterclass_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['masterclass']['img']['background_secondary_upload'] = array(
    '#type' => 'file',
    '#title' => t('Upload sub-page background image'),
  );

  $form['masterclass']['img']['backstretch'] = array(
    '#type' => 'checkbox',
  ...
  $form['#validate'][] = '_masterclass_settings_img_validate';

  $version = theme_get_setting('masterclass_settings_template');
  // Create the settings form.
  $form['masterclass']['masterclass_settings_template'] = array(
    '#type' => 'select',
  ...
  $columns = theme_get_setting('masterclass_settings_columns');
  if (empty($columns)) {
    $columns = '3-1';
  }
  $form['masterclass']['masterclass_settings_columns'] = array(
    '#type' => 'select',
    '#title' => t('Column Grid'),
  ...
  $form['masterclass']['masterclass_settings_custom_logo'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use Custom Logo'),
    '#description' => t('If you do not want to use the logo provider by the brand.masterclass.edu.au injector, check this box. You will need to use your theme\'s logo or include some custom CSS.'),
    '#default_value' => theme_get_setting('masterclass_settings_custom_logo'),
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_site_search_box'] = array(
    '#type' => 'checkbox',
    '#title' => t('Site search box'),
    '#description' => t('Display a site search box'),
    '#default_value' => theme_get_setting('masterclass_settings_site_search_box'),
    '#required' => false,
  );

	$form['masterclass']['masterclass_settings_dropdown_menu_and_search_box'] = array(
    '#type' => 'checkbox',
    '#title' => t('Dropdown menu and search box'),
    '#description' => t('Display dropdown menu and search box'),
    '#default_value' => theme_get_setting('masterclass_settings_dropdown_menu_and_search_box'),
    '#required' => false,
  );

	$form['masterclass']['viewport_initial_scale'] = array(
    '#type' => 'textfield',
  ...
  $form['masterclass']['masterclass_settings_parent-org'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => theme_get_setting('masterclass_settings_parent-org'),
    '#size' => 60,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_parent-org-url'] = array(
    '#type' => 'textfield',
    '#title' => t('Parent organisational unit URL (optional)'),
    '#description' => t('eg. http://www.masterclass.edu.au'),
    '#default_value' => theme_get_setting('masterclass_settings_parent-org-url'),
    '#size' => 60,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ht-left'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => theme_get_setting('masterclass_settings_ht-left'),
    '#size' => 40,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ht-right'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => theme_get_setting('masterclass_settings_ht-right'),
    '#size' => 120,
    '#maxlength' => 1024,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_meta-keywords'] = array(
    '#type' => 'textfield',
    '#title' => t('Meta keywords (optional)'),
    '#description' => t('Comma-separated list of keywords for use in meta tags'),
    '#default_value' => theme_get_setting('masterclass_settings_meta-keywords'),
    '#size' => 120,
    '#maxlength' => 1024,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-line1'] = array(
    '#type' => 'textfield',
    '#title' => t('Address Line 1 (optional)'),
    '#description' => t('eg. Level 1, Raymond Priestly Building'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-line1'),
    '#size' => 60,
    '#maxlength' => 512,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-line2'] = array(
    '#type' => 'textfield',
    '#title' => t('Address Line 2 (optional)'),
    '#description' => t('eg. University of Melbourne'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-line2'),
    '#size' => 60,
    '#maxlength' => 512,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-sub'] = array(
    '#type' => 'textfield',
    '#title' => t('City or suburb (optional)'),
    '#description' => t('eg. Parkville'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-sub'),
    '#size' => 40,
    '#maxlength' => 512,
    '#required' => FALSE,
  ); 

  $form['masterclass']['masterclass_settings_ad-postcode'] = array(
    '#type' => 'textfield',
    '#title' => t('Postcode (optional)'),
    '#description' => t('eg. 3010'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-postcode'),
    '#size' => 20,
    '#maxlength' => 10,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-state'] = array(
    '#type' => 'textfield',
    '#title' => t('State or territory (optional)'),
    '#description' => t('eg. VIC'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-state'),
    '#size' => 20,
    '#maxlength' => 64,
    '#required' => FALSE,
  ); 

  $form['masterclass']['masterclass_settings_ad-country'] = array(
    '#type' => 'textfield',
    '#title' => t('Country (optional)'),
    '#description' => t('eg. Australia'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-country'),
    '#size' => 20,
    '#maxlength' => 64,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-phone'] = array(
    '#type' => 'textfield',
    '#title' => t('Phone (required)'),
    '#description' => t('eg. +61 3 8344 1670'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-phone'),
    '#size' => 20,
    '#maxlength' => 64,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-fax'] = array(
    '#type' => 'textfield',
    '#title' => t('Fax (optional)'),
    '#description' => t('eg. +61 3 8344 1670'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-fax'),
    '#size' => 20,
    '#maxlength' => 64,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_ad-email'] = array(
    '#type' => 'textfield',
    '#title' => t('Email (required)'),
    '#description' => t('Email address for general enquiries, eg. example@masterclass.edu.au'),
    '#default_value' => theme_get_setting('masterclass_settings_ad-email'),
    '#size' => 40,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_fb-url'] = array(
    '#type' => 'textfield',
    '#title' => t('Facebook URL (optional)'),
    '#description' => t('eg. http://www.facebook.com/melbuni'),
    '#default_value' => theme_get_setting('masterclass_settings_fb-url'),
    '#size' => 60,
    '#maxlength' => 1024,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_tw-url'] = array(
    '#type' => 'textfield',
    '#title' => t('Twitter (optional)'),
    '#description' => t('eg. http://www.facebook.com/masterclass'),
    '#default_value' => theme_get_setting('masterclass_settings_tw-url'),
    '#size' => 60,
    '#maxlength' => 1024,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_wordpress-url'] = array(
    '#type' => 'textfield',
    '#title' => t('Wordpress (optional)'),
    '#description' => t('eg. Your wordpress url'),
    '#default_value' => theme_get_setting('masterclass_settings_wordpress-url'),
    '#size' => 60,
    '#maxlength' => 1024,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_auth-name'] = array(
    '#type' => 'textfield',
    '#title' => t('Authoriser Name and or Position (required)'),
    '#description' => t('eg. Jane Smith, Faculty of Bar'),
    '#default_value' => theme_get_setting('masterclass_settings_auth-name'),
    '#size' => 80,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_maint-name'] = array(
    '#type' => 'textfield',
    '#title' => t('Maintainer Name and or Position (required)'),
    '#description' => t('eg. Pat Doe, Faculty of Bar'),
    '#default_value' => theme_get_setting('masterclass_settings_maint-name'),
    '#size' => 80,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['masterclass_settings_date-created'] = array(
    '#type' => 'textfield',
    '#title' => t('Date created (optional)'),
    '#description' => t('The date the site was launched, eg. 11 February 2010'),
    '#default_value' => theme_get_setting('masterclass_settings_date-created'),
    '#size' => 20,
    '#maxlength' => 256,
    '#required' => FALSE,
  );

  $form['masterclass']['debug'] = array(
    '#type' => 'fieldset',
    '#title' => t('Debug'),
  ...
  $form['masterclass']['debug']['debug'] = array(
    '#type' => 'checkbox',
  ...
  $form['masterclass']['debug']['debug_host'] = array(
    '#type' => 'textfield',
    '#title' => t('Debug host'),
  ...
  $form['masterclass']['debug']['debug_port'] = array(
    '#type' => 'textfield',
    '#title' => t('Debug port'),
    '#size' => 6,
    '#maxlength' => 6,
 ...
 */
function _masterclass_settings_img_validate($form, &$form_state) {
  ...
  if ($file = $values['title_image_upload']) {
    ...
    form_set_value($form['masterclass']['img']['title_image_path'], $values['title_image_path'], $form_state);
  }
  ...
  if ($file = $values['background_front_upload']) {
    ...
    form_set_value($form['masterclass']['img']['background_front_path'], $values['background_front_path'], $form_state);
  }
  ...
  if ($file = $values['background_secondary_upload']) {
    ...
    form_set_value($form['masterclass']['img']['background_secondary_path'], $values['background_secondary_path'], $form_state);
  }
}
